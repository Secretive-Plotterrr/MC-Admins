...
function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    // Superadmin login
    if (emailTrimmed === 'superadmin@gmail.com' && passwordTrimmed === '12345') {
      setIsLoading(true);

      if (rememberMe) {
        localStorage.setItem(
          'rememberedCredentials',
          JSON.stringify({ email: emailTrimmed, password: passwordTrimmed })
        );
      } else {
    ...
    // Regular admin login
    if (emailTrimmed === 'admin@gmail.com' && passwordTrimmed === '12345') {
      setIsLoading(true);
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Let's Monitor Your Events Today!
            </p>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="admin@gmail.com or superadmin@gmail.com"
                  required
                  disabled={isLoading}
