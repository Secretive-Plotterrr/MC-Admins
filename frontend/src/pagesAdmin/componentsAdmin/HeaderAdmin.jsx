// src/pagesAdmin/componentsAdmin/HeaderAdmin.jsx
        ...
        {isProfileOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-50 border border-gray-200 dark:border-gray-700">
            ...
            <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
              <p className="text-sm font-medium text-gray-900 dark:text-white">Super Administrator</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 truncate">
                superadmin@mabinicolleges.edu.ph
              </p>
            </div>
