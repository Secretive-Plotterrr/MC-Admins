...
function Sidebar({ isOpen, toggleSidebar }) {
  ...
  // Menu items – grouped logically for MCEEvent
  const menuItems = [
    {
      path: '/dashboard',
      label: 'Dashboard',
    ...
    },
    {
      path: '/announcements',
      label: 'Announcements',
      icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.803l-1.104-4.417M4.5 3h15a1 1 0 011 1v16a1 1 0 01-1 1h-15a1 1 0 01-1-1V4a1 1 0 011-1z M15 10l-3 3m0 0l-3-3m3 3V3',
    },
    {
      path: '/events',
      label: 'Events',
    ...
    },
    {
      path: '/organizations',
      label: 'Organizations',
      icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM6 5a2 2 0 11-4 0 2 2 0 014 0z',
    },
    {
      path: '/reports',
      label: 'Reports',
